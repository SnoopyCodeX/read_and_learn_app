...
class FinishedStudentScreen extends StatefulWidget {
  final Story story;

  const FinishedStudentScreen(this.story);

  @override
  _FinishedStudentScreenState createState() => _FinishedStudentScreenState();
}

class _FinishedStudentScreenState extends State<FinishedStudentScreen> {
  @override
