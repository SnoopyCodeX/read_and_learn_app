...
class _AddEditTeacherScreenState extends State<AddEditTeacherScreen> {
  ...
  void initState() {
    ...
    _schoolNameController = TextEditingController(text: widget.user != null ? widget.user!.schoolName : '');
    _schoolAddressController = TextEditingController(text: widget.user != null ? widget.user!.schoolAddress : '');
  }
  ...
  void _showCreateTeacherDialog() {
    Utils.showAlertDialog(
      ...
      message: 'Are you sure you want to create a new teacher?', 
      actions: [
        TextButton(
          onPressed: () => _createOrUpdateTeacher(), 
          child: Text(
            'Yes',
            style: GoogleFonts.poppins(
              fontWeight: FontWeight.bold,
  ...
  Future<void> _createOrUpdateTeacher() async {
    ...
    if(_firstname.isEmpty || _lastname.isEmpty || _email.isEmpty || _gender.isEmpty || _password.isEmpty || _schoolName.isEmpty || _schoolAddress.isEmpty)
      Utils.showSnackbar(
        context: context, 
