...
class ClassroomPanel extends StatefulWidget {
  ...
  const ClassroomPanel(
      this.classroom, this.reloadAndOpenRoom, this.resetSelectedRoom);
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Body(widget.classroom, widget.reloadAndOpenRoom,
                widget.resetSelectedRoom),
          ),
          bottomNavigationBar: BottomBar(
            backgroundColor: Colors.white,
            selectedIndex:
                Provider.of<TempVariables>(context, listen: true).tempIndex,
